...
class CombinedSolver : public CombinedSolverBase
{
	public:
            ...
            CombinedSolverBase("Embedded Mesh Deformation"), m_constraintsIdx(constraintsIdx), m_constraintsTarget(constraintsTarget)
		{
            ...
            m_rotationMatrices = createEmptyThalloImage(imdims, ThalloImage::Type::FLOAT, 9, ThalloImage::GPU, true);
            m_vertexPositions = createEmptyThalloImage(imdims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_vertexTargets = createEmptyThalloImage(imdims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_urshape = createEmptyThalloImage(imdims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
	...
	private:
		...
		std::shared_ptr<ThalloImage>   m_rotationMatrices;
        std::shared_ptr<ThalloImage>   m_vertexTargets;
        std::shared_ptr<ThalloImage>   m_vertexPositions;
