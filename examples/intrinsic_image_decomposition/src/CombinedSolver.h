...
class CombinedSolver : public CombinedSolverBase
{
	public:
        ...
        CombinedSolver(const ColorImageR32G32B32A32& image, const CombinedSolverParameters& params) : 
            ...
            m_targetFloat3 = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_imageFloat3Albedo = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_imageFloatIllumination = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 1, ThalloImage::GPU, true);
	...
	private:
		...
		std::shared_ptr<ThalloImage> m_imageFloat3Albedo;
		std::shared_ptr<ThalloImage> m_imageFloatIllumination;
		std::shared_ptr<ThalloImage> m_targetFloat3;
};
