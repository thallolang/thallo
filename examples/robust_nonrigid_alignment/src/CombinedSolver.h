...
class CombinedSolver : public CombinedSolverBase
{
	...
	public:
            ...
            : CombinedSolverBase("Robust Mesh Deformation")
		{
            ...
            m_vertexPosTargetFloat3     = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::Location::GPU, true);
            m_vertexNormalTargetFloat3  = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::Location::GPU, true);
            m_robustWeights             = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 1, ThalloImage::Location::GPU, true);
            m_vertexPosFloat3           = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::Location::GPU, true);
            m_vertexPosFloat3Urshape    = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::Location::GPU, true);
            m_anglesFloat3              = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::Location::GPU, true);
            ...
            std::vector<unsigned int> thallodims = { N,m_edgeCount };
            addThalloSolvers(thallodims);
		} 
...
//#pragma omp parallel for // TODO: check why it makes everything wrongs
        ...
        void generateThalloEdges(std::vector<int>& h_numNeighbours, std::vector<int>&	h_neighbourIdx, std::vector<int>& h_neighbourOffset) {
		...
		void resetGPUMemory()
		{
            ...
            generateThalloEdges(h_numNeighbours, h_neighbourIdx, h_neighbourOffset);
	...
	private:
        ...
        std::shared_ptr<ThalloImage> m_vertexNormalTargetFloat3;
		std::shared_ptr<ThalloImage> m_vertexPosFloat3;
		std::shared_ptr<ThalloImage> m_vertexPosFloat3Urshape;
        std::shared_ptr<ThalloImage> m_robustWeights;
