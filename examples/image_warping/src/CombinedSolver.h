...
public:
    CombinedSolver(const ColorImageR32& image, const ColorImageR32G32B32& imageColor, const ColorImageR32& imageMask, std::vector<std::vector<int>>& constraints, CombinedSolverParameters params) :  
        ...
        m_urshape       = createEmptyThalloImage(m_dims, ThalloImage::Type::FLOAT, 2, ThalloImage::GPU, true);
        m_warpField     = createEmptyThalloImage(m_dims, ThalloImage::Type::FLOAT, 2, ThalloImage::GPU, true);
        m_warpAngles    = createEmptyThalloImage(m_dims, ThalloImage::Type::FLOAT, 1, ThalloImage::GPU, true);
        m_constraintImage = createEmptyThalloImage(m_dims, ThalloImage::Type::FLOAT, 2, ThalloImage::GPU, true);
        m_mask          = createEmptyThalloImage(m_dims, ThalloImage::Type::FLOAT, 1, ThalloImage::GPU, true);
...
private:
	...
	std::shared_ptr<ThalloImage> m_urshape;
    std::shared_ptr<ThalloImage> m_warpField;
    std::shared_ptr<ThalloImage> m_constraintImage;
	std::shared_ptr<ThalloImage> m_warpAngles;
    std::shared_ptr<ThalloImage> m_mask;
