...
// Rotation Matrix
inline __host__ __device__ mat3x3 evalRMat(float CosAlpha, float CosBeta, float CosGamma, float SinAlpha, float SinBeta, float SinGamma)
{
	mat3x3 R;
...
inline __host__ __device__ mat3x3 evalRMat(const float3& angles)
{
