...
class CombinedSolver : public CombinedSolverBase
{
	public:
            ...
            : CombinedSolverBase("Volumetric Mesh Deformation")
		{
            ...
            m_gridPosFloat3         = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_gridAnglesFloat3      = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_gridPosFloat3Urshape  = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
            m_gridPosTargetFloat3   = createEmptyThalloImage(dims, ThalloImage::Type::FLOAT, 3, ThalloImage::GPU, true);
	...
	private:
        ...
        std::shared_ptr<ThalloImage> m_gridPosTargetFloat3;
        std::shared_ptr<ThalloImage> m_gridPosFloat3;
        std::shared_ptr<ThalloImage> m_gridPosFloat3Urshape;
        std::shared_ptr<ThalloImage> m_gridAnglesFloat3;
